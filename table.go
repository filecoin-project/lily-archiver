...
var TableList = []Table{
	...
	// used for actors v6 and below, up to network v14
	{
		...
		Schema:              1,
		Task:                "actorstatesminer",
		Model:               &miner.MinerSectorInfoV1_4{},
